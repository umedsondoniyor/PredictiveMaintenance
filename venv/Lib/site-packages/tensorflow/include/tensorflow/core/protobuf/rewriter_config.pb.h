...
extern RewriterConfig_CustomGraphOptimizer_ParameterMapEntryDefaultTypeInternal _RewriterConfig_CustomGraphOptimizer_ParameterMapEntry_default_instance_;
...
class RewriterConfig_CustomGraphOptimizer : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.RewriterConfig.CustomGraphOptimizer) */ {
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  public:
  class RewriterConfig_CustomGraphOptimizer_ParameterMapEntry : public ::google::protobuf::internal::MapEntry<RewriterConfig_CustomGraphOptimizer_ParameterMapEntry, 
      ::std::string, ::tensorflow::AttrValue,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_MESSAGE,
      0 > {
  public:
    typedef ::google::protobuf::internal::MapEntry<RewriterConfig_CustomGraphOptimizer_ParameterMapEntry, 
      ::std::string, ::tensorflow::AttrValue,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_MESSAGE,
      0 > SuperType;
    RewriterConfig_CustomGraphOptimizer_ParameterMapEntry();
    RewriterConfig_CustomGraphOptimizer_ParameterMapEntry(::google::protobuf::Arena* arena);
    void MergeFrom(const ::google::protobuf::Message& other) PROTOBUF_FINAL;
    void MergeFrom(const RewriterConfig_CustomGraphOptimizer_ParameterMapEntry& other);
    static const Message* internal_default_instance() { return reinterpret_cast<const Message*>(&_RewriterConfig_CustomGraphOptimizer_ParameterMapEntry_default_instance_); }
