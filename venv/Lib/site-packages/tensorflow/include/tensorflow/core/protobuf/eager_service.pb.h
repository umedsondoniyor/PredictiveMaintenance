...
class Operation_AttrsEntry;
class Operation_AttrsEntryDefaultTypeInternal;
extern Operation_AttrsEntryDefaultTypeInternal _Operation_AttrsEntry_default_instance_;
class QueueItem;
...
class Operation : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.eager.Operation) */ {
 ...
 private:
  ...
  public:
  class Operation_AttrsEntry : public ::google::protobuf::internal::MapEntry<Operation_AttrsEntry, 
      ::std::string, ::tensorflow::AttrValue,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_MESSAGE,
      0 > {
  public:
    typedef ::google::protobuf::internal::MapEntry<Operation_AttrsEntry, 
      ::std::string, ::tensorflow::AttrValue,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_MESSAGE,
      0 > SuperType;
    Operation_AttrsEntry();
    Operation_AttrsEntry(::google::protobuf::Arena* arena);
    void MergeFrom(const ::google::protobuf::Message& other) PROTOBUF_FINAL;
    void MergeFrom(const Operation_AttrsEntry& other);
    static const Message* internal_default_instance() { return reinterpret_cast<const Message*>(&_Operation_AttrsEntry_default_instance_); }
...
inline void RegisterFunctionRequest::clear_function_def() {
